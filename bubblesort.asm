...
message: .asciiz "Array at given veda memory: "			#message to be printed
...
# Store the sorted array back into the data memory
#addi $r9, $zero, 0     # $r9 is the loop counter for copying
#addi $r10, $zero, 0    # $r10 is the index of the next element to copy
#loop_copy:
    #mul $r11, $r9, $r8  # calculate index of current element to copy
    #add $r11, $r11, $r10
    #sll $r11, $r11, 2
    #lw $r12, 0($r11)    # load current element
    #sw $r12, 0($r10)    # store current element at new index
    #addi $r9, $r9, 1    # increment loop
    #addi $r10, $r10, 4  # increment index of next element to copy
    #ble $r9, $r8, loop_copy # continue loop if not done copying
